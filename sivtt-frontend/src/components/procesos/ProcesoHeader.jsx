        ...
        <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm">
              {estadoStyle && (
                <Badge variant="secondary" className={cn('text-xs font-medium border gap-1.5', estadoStyle.bgClass, estadoStyle.textClass, estadoStyle.borderClass)}>
              ...
              <div className="flex items-center gap-2">
                ...
                {faseStyle ? (
                  <Badge variant="secondary" className={cn('text-xs font-medium', faseStyle.bgClass, faseStyle.textClass)}>
                    {faseStyle.label}
                  </Badge>
                ) : (
                  <span className="font-medium text-foreground bg-muted px-2 py-0.5 rounded text-xs">{proceso.faseActual}</span>
                )}
              </div>
